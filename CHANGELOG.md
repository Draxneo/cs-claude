...
- Chat: Claude replies now render formatting (bold, bullet/numbered lists), message timestamps, tap-to-copy on replies.
- Hands-free: mic button (voice-to-text) in the composer where supported.
